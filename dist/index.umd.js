        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(material.Paper, __assign({ sx: { p: 1 }, elevation: 0, ref: filesCardRef, variant: "outlined" }, containerCompatibilityProps),
                React.createElement(material.Typography, { gutterBottom: true, component: "div", color: "textSecondary", sx: { display: 'flex' } },
                    React.createElement(material.Box, { sx: { flexGrow: 1, fontSize: TitleProps === null || TitleProps === void 0 ? void 0 : TitleProps.fontSize } }, title),
                    ...
                    React.createElement(material.Grid, { container: true, spacing: 2, alignItems: "center", justifyContent: "center" },
                        ...
                        React.createElement(material.Grid, __assign({ item: true, xs: 12, sm: true, md: true, sx: {
                            ...
                            React.createElement(material.Hidden, { smDown: true },
                                React.createElement(material.Typography, __assign({ variant: "h5" }, HeaderCompatibilityProps),
                                    React.createElement("b", null, header))),
                            React.createElement(material.Hidden, { smUp: true },
                                React.createElement(material.Typography, __assign({ variant: "h6" }, HeaderCompatibilityProps),
                                    React.createElement("b", null, header))),
                            React.createElement(material.Typography, __assign({ variant: "caption" }, LabelCompatibilityProps),
                                leftLabel,
                                React.createElement(material.Button, __assign({ size: "small", color: "secondary", variant: "outlined", disabled: disabled, onClick: function () { var _a; return (_a = inputRef.current) === null || _a === void 0 ? void 0 : _a.click(); }, sx: {
                                        m: .5,
                ...
                (files === null || files === void 0 ? void 0 : files.length) > 0 &&
                    React.createElement(React.Fragment, null,
                        ...
                        React.createElement(material.Typography, { component: "div", align: "right", sx: { mt: 1 } },
                            React.createElement(material.Button, __assign({ size: "small", disabled: disabled, onClick: removeFile, ref: buttonDeleteRef }, ButtonRemoveCompatibilityProps), buttonRemoveLabel || 'Remove all'))))));
    }
